...
declare global {
  ...
  const apiLoginOut: typeof import('./api/modules/bearlen')['apiLoginOut']
  const apiReturnSortCloseOrder: typeof import('./api/modules/bearlen')['apiReturnSortCloseOrder']
  const apiReturnSortConfirmGoods: typeof import('./api/modules/bearlen')['apiReturnSortConfirmGoods']
  const apiReturnSortConfirmWhole: typeof import('./api/modules/bearlen')['apiReturnSortConfirmWhole']
  const apiReturnSortDetail: typeof import('./api/modules/bearlen')['apiReturnSortDetail']
  const apiReturnSortGoodsAbnormal: typeof import('./api/modules/bearlen')['apiReturnSortGoodsAbnormal']
  const apiReturnSortScan: typeof import('./api/modules/bearlen')['apiReturnSortScan']
  const apiSign: typeof import('./api/modules/bearlen')['apiSign']
  const apiVerify: typeof import('./api/modules/bearlen')['apiVerify']
  ...
  const getMultipartUploadAuthHeaders: typeof import('./utils/authStorage')['getMultipartUploadAuthHeaders']
  const getPersistedBearerToken: typeof import('./utils/authStorage')['getPersistedBearerToken']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly apiLoginOut: UnwrapRef<typeof import('./api/modules/bearlen')['apiLoginOut']>
    readonly apiReturnSortCloseOrder: UnwrapRef<typeof import('./api/modules/bearlen')['apiReturnSortCloseOrder']>
    readonly apiReturnSortConfirmGoods: UnwrapRef<typeof import('./api/modules/bearlen')['apiReturnSortConfirmGoods']>
    readonly apiReturnSortConfirmWhole: UnwrapRef<typeof import('./api/modules/bearlen')['apiReturnSortConfirmWhole']>
    readonly apiReturnSortDetail: UnwrapRef<typeof import('./api/modules/bearlen')['apiReturnSortDetail']>
    readonly apiReturnSortGoodsAbnormal: UnwrapRef<typeof import('./api/modules/bearlen')['apiReturnSortGoodsAbnormal']>
    readonly apiReturnSortScan: UnwrapRef<typeof import('./api/modules/bearlen')['apiReturnSortScan']>
    readonly apiSign: UnwrapRef<typeof import('./api/modules/bearlen')['apiSign']>
    readonly apiVerify: UnwrapRef<typeof import('./api/modules/bearlen')['apiVerify']>
    ...
    readonly getMultipartUploadAuthHeaders: UnwrapRef<typeof import('./utils/authStorage')['getMultipartUploadAuthHeaders']>
    readonly getPersistedBearerToken: UnwrapRef<typeof import('./utils/authStorage')['getPersistedBearerToken']>
